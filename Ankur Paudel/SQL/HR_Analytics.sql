...
COPY employee_survey_data
FROM '[PATH_TO_CSV]' NULL AS 'NA' DELIMITER ',' CSV HEADER;
----- CHANGE FILE PATH TO employee_survey_data.csv HERE
...
COPY general_data
FROM '[PATH_TO_CSV]' NULL AS 'NA' DELIMITER ',' CSV HEADER;
----- CHANGE FILE PATH TO general_data.csv HERE
...
COPY manager_survey_data
FROM '[PATH_TO_CSV]' NULL AS 'NA' DELIMITER ',' CSV HEADER;
----- CHANGE FILE PATH TO manager_survey_data.csv HERE
...
CREATE TEMP TABLE TABLE_ROW_COUNT AS (
    ...
    UNION ALL
    SELECT 'general_data' AS TABLE_NAME,
        COUNT(*) AS NO_ROWS
    FROM GENERAL_DATA
    UNION ALL
    SELECT 'manager_survey_data' AS TABLE_NAME,
        COUNT(*) AS NO_ROWS
